...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function getBlockTimeStampFromDate(string memory _date) 
            internal 
            pure 
            isIsoDate(_date) 
            returns (uint)	
	...
	function getNow(uint timeStamp) 
        internal 
        pure 
        returns (string memory)
	{
	...
	function getNow(uint timeStamp, uint showTime) 
        internal 
        pure 
        returns (string memory)
	{
	...
	function getNow(uint timeStamp, uint showTime, uint showIsoDate) 
        internal 
        pure 
        returns (string memory)
	{
