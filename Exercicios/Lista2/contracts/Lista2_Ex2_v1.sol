...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function getValor() public view onlyOwner returns (string memory)
    {
        string memory ret = getNow();

        return ret;
    }

    function dt_getNow() public view onlyOwner returns (string memory)
    {
        return getNow();
    }

    function dt_getNowComValor(uint valor) public view onlyOwner returns (string memory)
    {
        // 1646538261 agora
    ...
    function dt_getblockTime() public view onlyOwner returns (uint)
    {
        return block.timestamp;
    }
 
    // function dt_getBlockTimeStampFromDate() public view onlyOwner returns (uint)
    function dt_getBlockTimeStampFromDate(string memory theDate) public view onlyOwner returns (uint)
    {
    ...
    function getArray_Campanhas() public view onlyOwner returns (Campanha[] memory)
    {
        return arrCampanhas;
    }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function internal_getIDUserFromSender() private view returns (int)
    {
    ...
    function internal_usuario_cadastrar(string memory _nome, address _endereco) private isAddressOk(_endereco) noReentrancy
    {
    ...
    function internal_usuario_pesquisarPorEndereco(address _endereco) private view isAddressOk(_endereco) userExists(_endereco) returns (Usuario memory)
    {
    ...
    function internal_usuario_apagarUsuario(address _endereco) private isAddressOk(_endereco) userExists(_endereco) noReentrancy
    {
    ...
    function internal_campanha_cadastrar(string memory _nome, address _endereco, uint _valorAlvo, string memory _Inicio, string memory _Termino) private isAddressOk(_endereco) userExists(_endereco) noReentrancy
    {
        ...
        // uint hoje_blocoMinimo = getBlockTimeStampFromDate(_hoje);

        if (local_campanha_datas.inicio_blocoMinimo >= local_campanha_datas.termino_blocoMaximo)
        {
            require(1==2, "O termino nao pode ser antes do inicio");
        }
  
        if (local_campanha_datas.inicio_blocoMinimo < local_campanha_datas.hoje_blocoMinimo)
        {
            require(1==2, "O inicio nao pode ser anterior a hoje");
        }  

        // Cria a campanha     internal_getIDUserFromSender   
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function ADMIN_Usuario_CadastrarNovoUsuario(string memory _nome, address _endereco) public onlyOwner
    {
        internal_usuario_cadastrar(_nome, _endereco);
    }

    // Pesquisar um usuario qualquer por endereco (test ok)
    function ADMIN_Usuario_PesquisarPorEndereco(address _endereco) public view onlyOwner returns (Usuario memory)
    {
        return internal_usuario_pesquisarPorEndereco(_endereco);
    }

    // Apagar um usuario por endereco (test ok)
    function ADMIN_Usuario_ApagarUsuarioPorEndereco(address _endereco) public onlyOwner
    {
    ...
    function ADMIN_Campanha_CadastrarNovaCampanha(string memory _nome, address _endereco, uint _valorAlvo, string memory _Inicio, string memory _Termino) public onlyOwner
    {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function MeuUsuario_CadastrarNovoUsuario(string memory _nome) public
    {
        internal_usuario_cadastrar(_nome, msg.sender);
    }

    // Pesquisar o meu usuario (test ok)
    function MeuUsuario_Pesquisar() public view returns (Usuario memory)
    {
        return internal_usuario_pesquisarPorEndereco(msg.sender);
    }

    // Apagar o meu usuario (test ok)
    function MeuUsuario_ApagarUsuario() public noReentrancy
    {
    ...
    // Cadastro de uma nova campanha
    // Formato de Inicio e Termino: YYYY-MM-DD
    function MeuUsuario_CadastrarNovaCampanha(string memory _nome, uint _valorAlvo, string memory _Inicio, string memory _Termino) public
    {
